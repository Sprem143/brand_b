...
async function fetchAndExtractVariable2(html, variableName) {
...
exports.autofetchdata5 = async(req, res) => {
    ...
    try {
        ...
        const utagData = await fetchAndExtractVariable2(html, 'utag_data');
